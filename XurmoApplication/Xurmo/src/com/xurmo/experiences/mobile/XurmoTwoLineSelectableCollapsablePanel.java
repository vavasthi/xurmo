...
public class XurmoTwoLineSelectableCollapsablePanel {
  
  /**
   * Creates a new instance of XurmoCollapsablePanel
   */
  public XurmoTwoLineSelectableCollapsablePanel(int screenWidth, int screenHeight, Image icon, String title) {
    w_ = screenWidth;

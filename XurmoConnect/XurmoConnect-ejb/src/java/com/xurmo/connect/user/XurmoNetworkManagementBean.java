...
public class XurmoNetworkManagementBean implements com.xurmo.connect.user.XurmoNetworkManagementRemote, com.xurmo.connect.user.XurmoNetworkManagementLocal {
    @PersistenceContext

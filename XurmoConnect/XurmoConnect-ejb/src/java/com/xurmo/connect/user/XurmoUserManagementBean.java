...
public class XurmoUserManagementBean implements XurmoUserManagementRemote, XurmoUserManagementLocal {
  ...
  public XurmoUserPreferenceDetails getUserPreferences(String username, String cookie, String mobileCountryCode, String mobileNetworkCode,  String siteId, String cellId, String cellName) {
    try {
      ...
      if (xus != null && cookie.equals(xus.getCookie())) {
        ...
        XurmoCellLocationMap xclm
            = XurmoLocationManager.updateLocationMap(mobileCountryCode, mobileNetworkCode, siteId, cellId, cellName, em_);
        XurmoUser xu = (XurmoUser) (em_.createNamedQuery("XurmoUser.findByUsername").setParameter("username", username).getSingleResult());
        XurmoUserPreferenceDetails xupd = XurmoUserPreferenceManager.getUserPreferences(xu.getUserid(), em_);
        xupd.setStatus(new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONSTATUS_NO_ERROR, xus.getCookie(), xclm.getLocation()));
        return xupd;
      }
    } catch(Exception ex) {
      XurmoUserPreferenceDetails xupd = new XurmoUserPreferenceDetails();
      xupd.setStatus(new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONFAILED_FATAL_ERROR_WHILE_SETTING_PREFERENCES, "", ""));
      return xupd;
    }
    XurmoUserPreferenceDetails xupd = new XurmoUserPreferenceDetails();
    xupd.setStatus(new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONFAILED_USER_NOT_LOGGED_IN, "", ""));
    return xupd;
  }
  public XurmoUserManagementStatus setUserPreferences(String username, String cookie, XurmoUserPreferenceDetails xupd, String mobileCountryCode, String mobileNetworkCode,  String siteId, String cellId, String cellName) {
    try {
      ...
      if (xus != null && cookie.equals(xus.getCookie())) {
        ...
        XurmoCellLocationMap xclm
            = XurmoLocationManager.updateLocationMap(mobileCountryCode, mobileNetworkCode, siteId, cellId, cellName, em_);
        XurmoUser xu = (XurmoUser) (em_.createNamedQuery("XurmoUser.findByUsername").setParameter("username", username).getSingleResult());
        XurmoUserPreferenceManager.setUserPreferences(xu.getUserid(), xupd, em_);
        return new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONSTATUS_NO_ERROR, xus.getCookie(), xclm.getLocation());
      }
    } catch(Exception ex) {
      return new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONFAILED_FATAL_ERROR_WHILE_SETTING_PREFERENCES, "", "");
    }
    return new XurmoUserManagementStatus(XurmoUserInteractionStatus.INTERACTIONFAILED_USER_NOT_LOGGED_IN, "", "");
  }
}